...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from files app';
     *     $event->getRequest()->attributes->set('MUFilesModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('MUFilesModule_test');`
     *     now `$testMessage` should be: `'Hello from files app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('files App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
