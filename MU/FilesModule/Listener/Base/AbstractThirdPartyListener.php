...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function getEditorHelpers(\Zikula_Event $event)
    {
        ...
        $helpers->add(
            [
                ...
                'type'   => 'javascript',
                'path'   => 'modules/MU/FilesModule/Resources/public/js/MUFilesModule.Finder.js'
            ]
        );
    }
    ...
    public function getTinyMcePlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'mufilesmodule',
                'path' => 'modules/MU/FilesModule/Resources/scribite/TinyMce/mufilesmodule/plugin.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'mufilesmodule',
                'path' => 'modules/MU/FilesModule/Resources/scribite/CKEditor/mufilesmodule/',
                'file' => 'plugin.js',
