...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function contentGetTypes(\Zikula_Event $event)
    {
        ...
        $types->add('MUFilesModule_ContentType_Item');
        
        // plugin for showing a list of multiple items
        $types->add('MUFilesModule_ContentType_ItemList');
    }
    ...
    public function getEditorHelpers(EditorHelperEvent $event)
    {
        ...
        $event->getHelperCollection()->add(
            [
                ...
                'type' => 'javascript',
                'path' => $this->request->getBasePath() . '/web/modules/mufiles/js/MUFilesModule.Finder.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(GenericEvent $event)
    {
        $event->getSubject()->add([
            'name' => 'mufilesmodule',
            'path' => $this->request->getBasePath() . '/web/modules/mufiles/scribite/CKEditor/mufilesmodule/',
            'file' => 'plugin.js',
    ...
    public function getQuillPlugins(GenericEvent $event)
    {
        $event->getSubject()->add([
            'name' => 'mufilesmodule',
            'path' => $this->request->getBasePath() . '/web/modules/mufiles/scribite/Quill/mufilesmodule/plugin.js'
        ]);
    }
    ...
    public function getSummernotePlugins(GenericEvent $event)
    {
        $event->getSubject()->add([
            'name' => 'mufilesmodule',
            'path' => $this->request->getBasePath() . '/web/modules/mufiles/scribite/Summernote/mufilesmodule/plugin.js'
        ]);
    }
    ...
    public function getTinyMcePlugins(GenericEvent $event)
    {
        $event->getSubject()->add([
            'name' => 'mufilesmodule',
            'path' => $this->request->getBasePath() . '/web/modules/mufiles/scribite/TinyMce/mufilesmodule/plugin.js'
        ]);
    }
}
