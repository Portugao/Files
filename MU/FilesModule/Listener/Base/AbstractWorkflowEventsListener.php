...
use MU\FilesModule\Helper\NotificationHelper;
...
abstract class AbstractWorkflowEventsListener implements EventSubscriberInterface
{
    ...
    public function onGuard(GuardEvent $event)
    {
        ...
        $hasApproval = in_array($objectType, ['collection', 'file']);
        ...
        if (!$this->permissionApi->hasPermission('MUFilesModule:' . ucfirst($objectType) . ':', $entity->getKey() . '::', $permissionLevel)) {
        ...
        if ($transitionName == 'delete') {
            ...
            if ($objectType == 'collection') {
                $isBlocked = false;
                if (count($entity->getCollections()) > 0) {
                    $isBlocked = true;
                }
                if (count($entity->getAlilasfiles()) > 0) {
                    $isBlocked = true;
                }
    ...
    public function onEnter(Event $event)
    {
        ...
        if (in_array($entity->get_objectType(), ['collection', 'file'])) {
