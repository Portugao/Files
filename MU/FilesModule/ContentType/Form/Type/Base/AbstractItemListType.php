...
namespace MU\FilesModule\ContentType\Form\Type\Base;
...
abstract class AbstractItemListType extends AbstractContentFormType
{
    ...
    public function addObjectTypeField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('objectType', ChoiceType::class, [
            'label' => $this->__('Object type', 'mufilesmodule') . ':',
            'empty_data' => 'collection',
            'attr' => [
                'title' => $this->__('If you change this please save the element once to reload the parameters below.', 'mufilesmodule')
            ],
            'help' => $this->__('If you change this please save the element once to reload the parameters below.', 'mufilesmodule'),
            'choices' => [
                $this->__('Collections', 'mufilesmodule') => 'collection',
                $this->__('Files', 'mufilesmodule') => 'file'
            ],
            'multiple' => false,
            'expanded' => false
        ]);
    ...
    public function addCategoriesField(FormBuilderInterface $builder, array $options = [])
    {
        ...
        $builder->add('categories', CategoriesType::class, [
            'label' => ($hasMultiSelection ? $this->__('Categories', 'mufilesmodule') : $this->__('Category', 'mufilesmodule')) . ':',
            'empty_data' => $hasMultiSelection ? [] : null,
            'attr' => [
                'class' => 'category-selector',
                'title' => $this->__('This is an optional filter.', 'mufilesmodule')
            ],
            'help' => $this->__('This is an optional filter.', 'mufilesmodule'),
            'required' => false,
    ...
    public function addSortingField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('sorting', ChoiceType::class, [
            'label' => $this->__('Sorting', 'mufilesmodule') . ':',
            'empty_data' => 'default',
            'choices' => [
                $this->__('Random', 'mufilesmodule') => 'random',
                $this->__('Newest', 'mufilesmodule') => 'newest',
                $this->__('Updated', 'mufilesmodule') => 'updated',
                $this->__('Default', 'mufilesmodule') => 'default'
            ],
            'multiple' => false,
            'expanded' => false
        ]);
    ...
    public function addAmountField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('amount', IntegerType::class, [
            'label' => $this->__('Amount', 'mufilesmodule') . ':',
            'attr' => [
                'maxlength' => 2,
                'title' => $this->__('The maximum amount of items to be shown.', 'mufilesmodule') . ' ' . $this->__('Only digits are allowed.', 'mufilesmodule')
            ],
            'help' => $this->__('The maximum amount of items to be shown.', 'mufilesmodule') . ' ' . $this->__('Only digits are allowed.', 'mufilesmodule'),
            'empty_data' => 5,
            'scale' => 0
        ]);
    }
    ...
    public function addTemplateFields(FormBuilderInterface $builder, array $options = [])
    {
        $builder
            ->add('template', ChoiceType::class, [
                'label' => $this->__('Template', 'mufilesmodule') . ':',
                'empty_data' => 'itemlist_display.html.twig',
                'choices' => [
                    $this->__('Only item titles', 'mufilesmodule') => 'itemlist_display.html.twig',
                    $this->__('With description', 'mufilesmodule') => 'itemlist_display_description.html.twig',
                    $this->__('Custom template', 'mufilesmodule') => 'custom'
                ],
                'multiple' => false,
                'expanded' => false
            ])
            ->add('customTemplate', TextType::class, [
                'label' => $this->__('Custom template', 'mufilesmodule') . ':',
                'required' => false,
                'attr' => [
                    'maxlength' => 80,
                    'title' => $this->__('Example', 'mufilesmodule') . ': itemlist_[objectType]_display.html.twig'
                ],
                'help' => $this->__('Example', 'mufilesmodule') . ': <em>itemlist_[objectType]_display.html.twig</em>'
            ])
        ;
    }
    ...
    public function addFilterField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('filter', TextType::class, [
            'label' => $this->__('Filter (expert option)', 'mufilesmodule') . ':',
            'required' => false,
            'attr' => [
                'maxlength' => 255,
                'title' => $this->__('Example', 'mufilesmodule') . ': tbl.age >= 18'
            ],
            'help' => $this->__('Example', 'mufilesmodule') . ': tbl.age >= 18'
        ]);
    }
    ...
    {
        return 'mufilesmodule_contenttype_list';
    }
