...
abstract class AbstractItemType extends AbstractContentFormType
{
    ...
    public function addIdField(FormBuilderInterface $builder, array $options = [])
    {
        ...
        $builder->add('id', ChoiceType::class, [
            ...
            'choices' => $choices,
            'required' => true,
            'label' => $this->__('Entry to display', 'mufilesmodule') . ':'
        ]);
    }
    ...
    public function addDisplayModeField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('displayMode', ChoiceType::class, [
            'label' => $this->__('Display mode', 'mufilesmodule') . ':',
            'label_attr' => [
                'class' => 'radio-inline'
            ],
            'empty_data' => 'embed',
            'choices' => [
                $this->__('Link to object', 'mufilesmodule') => 'link',
                $this->__('Embed object display', 'mufilesmodule') => 'embed'
            ],
            'multiple' => false,
            'expanded' => true
        ]);
    ...
    public function addTemplateField(FormBuilderInterface $builder, array $options = [])
    {
        $builder
            ->add('customTemplate', TextType::class, [
                ...
                'attr' => [
                    'maxlength' => 80,
                    'title' => $this->__('Example', 'mufilesmodule') . ': displaySpecial.html.twig'
                ],
                'help' => [
                    $this->__('Example', 'mufilesmodule') . ': <em>displaySpecial.html.twig</em>',
                    $this->__('Needs to be located in the "External/YourEntity/" directory.', 'mufilesmodule')
                ]
            ])
        ;
    }
    ...
    {
        return 'mufilesmodule_contenttype_detail';
    }
