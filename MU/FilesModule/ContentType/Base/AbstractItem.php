...
abstract class AbstractItem extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        return $this->container->get('translator.default')->__('MUFilesModule detail view');
    }
    ...
    {
        return $this->container->get('translator.default')->__('Display or link a single MUFilesModule object.');
    }
    ...
    public function display()
    {
        ...
        $controllerReference = new ControllerReference('MUFilesModule:External:display', $this->getDisplayArguments(), ['template' => $this->customTemplate]);
