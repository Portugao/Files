...
use MU\FilesModule\ContentType\Form\Type\ItemType as FormType;
...
abstract class AbstractItemType extends AbstractContentType
{
    ...
    {
        return $this->translator->__('Files detail', 'mufilesmodule');
    }
    ...
    {
        return $this->translator->__('Display or link a single files object.', 'mufilesmodule');
    }
    ...
    public function displayView()
    {
        ...
        $controllerReference = new ControllerReference('MUFilesModule:External:display', $this->getDisplayArguments(), ['template' => $this->data['customTemplate']]);
    ...
    {
        if (null === $this->data['id'] || empty($this->data['id']) || empty($this->data['displayMode'])) {
            return $this->translator->__('No item selected.', 'mufilesmodule');
        }
