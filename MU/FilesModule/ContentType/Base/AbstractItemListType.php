...
use MU\FilesModule\ContentType\Form\Type\ItemListType as FormType;
...
abstract class AbstractItemListType extends AbstractContentType
{
    ...
    {
        return $this->translator->__('Files list', 'mufilesmodule');
    }
    ...
    {
        return $this->translator->__('Display a list of files objects.', 'mufilesmodule');
    }
    ...
    public function getViewTemplatePath($suffix = '')
    {
        ...
        foreach ($templateOptions as $templatePath) {
            if ($this->twigLoader->exists('@MUFilesModule/' . $templatePath)) {
