...
namespace MU\FilesModule\Twig\Base;
...
use MU\FilesModule\Helper\WorkflowHelper;
...
abstract class AbstractTwigExtension extends Twig_Extension
{
    ...
    {
        return [
            new \Twig_SimpleFunction('mufilesmodule_moderationObjects', [$this, 'getModerationObjects']),
            new \Twig_SimpleFunction('mufilesmodule_objectTypeSelector', [$this, 'getObjectTypeSelector']),
            new \Twig_SimpleFunction('mufilesmodule_templateSelector', [$this, 'getTemplateSelector'])
        ];
    }
    ...
    {
        return [
            new \Twig_SimpleFilter('mufilesmodule_fileSize', [$this, 'getFileSize'], ['is_safe' => ['html']]),
            new \Twig_SimpleFilter('mufilesmodule_listEntry', [$this, 'getListEntry']),
            new \Twig_SimpleFilter('mufilesmodule_formattedTitle', [$this, 'getFormattedEntityTitle']),
            new \Twig_SimpleFilter('mufilesmodule_objectState', [$this, 'getObjectState'], ['is_safe' => ['html']])
        ];
    }
    
    /**
     * The mufilesmodule_objectState filter displays the name of a given object's workflow state.
     * Examples:
     *    {{ item.workflowState|mufilesmodule_objectState }}        {# with visual feedback #}
     *    {{ item.workflowState|mufilesmodule_objectState(false) }} {# no ui feedback #}
     *
    ...
    /**
     * The mufilesmodule_fileSize filter displays the size of a given file in a readable way.
     * Example:
     *     {{ 12345|mufilesmodule_fileSize }}
     *
    ...
    /**
     * The mufilesmodule_listEntry filter displays the name
     * or names for a given list item.
     * Example:
     *     {{ entity.listField|mufilesmodule_listEntry('entityName', 'fieldName') }}
     *
    ...
    /**
     * The mufilesmodule_moderationObjects function determines the amount of unapproved objects.
    ...
    /**
     * The mufilesmodule_objectTypeSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    /**
     * The mufilesmodule_templateSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    /**
     * The mufilesmodule_formattedTitle filter outputs a formatted title for a given entity.
     * Example:
     *     {{ myPost|mufilesmodule_formattedTitle }}
     *
