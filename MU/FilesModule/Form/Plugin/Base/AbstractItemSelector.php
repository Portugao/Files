...
namespace MU\FilesModule\Form\Plugin\Base;
...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput implements ContainerAwareInterface
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            $jsAssetBag->add($assetHelper->resolve('@MUFilesModule:js/MUFilesModule.js'));
            $jsAssetBag->add($assetHelper->resolve('@MUFilesModule:js/MUFilesModule.ItemSelector.js'));
        ...
        if (!$permissionApi->hasPermission('MUFilesModule:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }

        $categorisableObjectTypes = ['collection'];
        $catIds = [];
        ...
        $view = Zikula_View::getInstance('MUFilesModule', false);
    ...
    public function decode(Zikula_Form_View $view)
    {
        ...
        $this->objectType = $request->request->get('MUFilesModule_objecttype', 'collection');
