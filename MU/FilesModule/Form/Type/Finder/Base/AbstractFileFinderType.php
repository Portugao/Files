...
abstract class AbstractFileFinderType extends AbstractType
{
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the file') => 1,
                $this->__('Absolute url to the file') => 2,
                $this->__('ID of file') => 3
            ],
            'multiple' => false,
            'expanded' => false
        ]);
        ...
        $builder
            ->add('sort', ChoiceType::class, [
                ...
                'choices' => [
                    ...
                    $this->__('Upload file') => 'uploadFile',
    ...
    {
        return 'mufilesmodule_filefinder';
    }
