 ...
 */
abstract class AbstractFileUiHooksProvider implements HookProviderInterface
{
    use ServiceIdTrait;
    ...
    /**
     * FileUiHooksProvider constructor.
     *
    ...
    {
        return $this->translator->__('File ui hooks provider');
    }
    ...
    {
        return 'provider.mufilesmodule.ui_hooks.files';
    }
    ...
    protected function selectAssignedEntities(Hook $hook)
    {
        ...
        $entities = $this->entityFactory->getRepository('file')->selectByIdList($assignedIds);
    ...
    protected function renderDisplayHookResponse(Hook $hook, $context)
    {
        ...
        $template = '@MUFilesModule/File/includeDisplayItemListMany.html.twig';
        ...
        $templateParameters['relationThumbRuntimeOptions'] = $this->imageHelper->getCustomRuntimeOptions('', '', 'MUFilesModule_relateditem', 'controllerAction', ['action' => 'display']);
