...
namespace MU\FilesModule\Block\Form\Type\Base;
...
abstract class AbstractItemListBlockType extends AbstractType
{
    ...
    public function addObjectTypeField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('objectType', ChoiceType::class, [
            ...
            'attr' => [
                'title' => $this->__('If you change this please save the block once to reload the parameters below.', 'mufilesmodule')
            ],
            'help' => $this->__('If you change this please save the block once to reload the parameters below.', 'mufilesmodule'),
            'choices' => [
    ...
    {
        return 'mufilesmodule_listblock';
    }
