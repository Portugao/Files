...
use MU\FilesModule\Block\Form\Type\ItemListBlockType;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    {
        return $this->__('Files list', 'mufilesmodule');
    }
    ...
    public function display(array $properties = [])
    {
        ...
        if (!$this->hasPermission('MUFilesModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return '';
        }
        ...
        // create query
        $orderBy = $this->get('mu_files_module.model_helper')->resolveSortParameter($objectType, $properties['sorting']);
        $qb = $repository->getListQueryBuilder($properties['filter'], $orderBy);
    
        if (in_array($objectType, $this->categorisableObjectTypes)) {
            if ($featureActivationHelper->isEnabled(FeatureActivationHelper::CATEGORIES, $properties['objectType'])) {
                $categoryHelper = $this->get('mu_files_module.category_helper');
        ...
        if ($featureActivationHelper->isEnabled(FeatureActivationHelper::CATEGORIES, $objectType)) {
            $entities = $this->get('mu_files_module.category_helper')->filterEntitiesByPermission($entities);
        }
    
        // set a block title
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('Files list', 'mufilesmodule');
        }
        ...
        $templateParameters = $this->get('mu_files_module.controller_helper')->addTemplateParameters($properties['objectType'], $templateParameters, 'block', []);
    ...
    public function getFormOptions()
    {
        ...
        return [
            ...
            'category_helper' => $this->get('mu_files_module.category_helper'),
            'feature_activation_helper' => $this->get('mu_files_module.feature_activation_helper')
        ];
    }
    ...
    {
        return '@MUFilesModule/Block/itemlist_modify.html.twig';
    }
