...
use MU\FilesModule\Entity\Factory\EntityInitialiser;
...
abstract class AbstractEntityFactory
{
    ...
    {
        $entityClass = 'MU\\FilesModule\\Entity\\' . ucfirst($objectType) . 'Entity';
     ...
     *
     * @return MU\FilesModule\Entity\collectionEntity The newly created entity instance
     */
    public function createCollection()
    {
        $entityClass = 'MU\\FilesModule\\Entity\\CollectionEntity';
     ...
     *
     * @return MU\FilesModule\Entity\fileEntity The newly created entity instance
     */
    public function createFile()
    {
        $entityClass = 'MU\\FilesModule\\Entity\\FileEntity';
    ...
    public function getIdField($objectType = '')
    {
        ...
        $entityClass = 'MUFilesModule:' . ucfirst($objectType) . 'Entity';
