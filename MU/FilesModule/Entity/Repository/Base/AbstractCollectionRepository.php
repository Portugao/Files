...
namespace MU\FilesModule\Entity\Repository\Base;
...
abstract class AbstractCollectionRepository extends EntityRepository
{
     ...
     */
    protected $mainEntityClass = 'MU\FilesModule\Entity\CollectionEntity';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'MUFilesModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'collections', 'userid' => $userId];
    ...
    public function selectByIdList($idList = [0], $useJoins = true, $slimMode = false)
    {
        ...
        if (!$slimMode && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('collection', $qb);
        }
    ...
    {
        $selection = ', tblCollection, tblCollections, tblAlilasfiles';
    ...
    protected function addJoinsToFrom(QueryBuilder $qb)
    {
        ...
        $qb->leftJoin('tbl.collections', 'tblCollections');
        $qb->leftJoin('tbl.alilasfiles', 'tblAlilasfiles');
