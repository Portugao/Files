...
{strip}"{gt text='Hooked module'}";"{gt text='Hooked object'}";"{gt text='Area id'}";"{gt text='Url'}";"{gt text='Object id'}";"{gt text='Url object'}";"{gt text='Workflow state'}"
;"{gt text='Collectionhook'}";"{gt text='Filehook'}"{/strip}
{foreach item='hookobject' from=$items}
{strip}
    "{$hookobject.hookedModule}";"{$hookobject.hookedObject}";"{$hookobject.areaId}";"{$hookobject.url}";"{$hookobject.objectId}";"{$hookobject.urlObject}";"{$item.workflowState|mufilesObjectState:false|lower}"
    ;"
