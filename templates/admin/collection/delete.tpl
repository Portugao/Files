...
<div class="mufiles-collection mufiles-delete">
    ...
    <form class="z-form" action="{modurl modname='MUFiles' type='admin' func='delete' ot='collection' id=$collection.id}" method="post">
        <div>
            ...
            <fieldset>
                ...
                <div class="z-buttons z-formbuttons">
                    ...
                    <a href="{modurl modname='MUFiles' type='admin' func='view' ot='collection'}">{icon type='cancel' size='small' __alt='Cancel' __title='Cancel'} {gt text='Cancel'}</a>
                </div>
            </fieldset>
