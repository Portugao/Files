{* purpose of this template: files rss feed in admin area *}
...
{foreach item='file' from=$items}
    <item>
        ...
        <link>{modurl modname='MUFiles' type='admin' func='display' ot='file' id=$file.id fqurl='1'}</link>
        <guid>{modurl modname='MUFiles' type='admin' func='display' ot='file' id=$file.id fqurl='1'}</guid>
