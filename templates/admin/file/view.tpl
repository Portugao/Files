...
<div class="mufiles-file mufiles-view">
    ...
    {include file='admin/file/view_quickNav.tpl' all=$all own=$own}{* see template file for available options *}

    <form action="{modurl modname='MUFiles' type='admin' func='handleSelectedEntries'}" method="post" id="filesViewForm" class="z-form">
        <div>
            ...
            {if !isset($showAllEntries) || $showAllEntries ne 1}
                {pager rowcount=$pager.numitems limit=$pager.itemsperpage display='page' modname='MUFiles' type='admin' func='view' ot='file'}
            {/if}
            <fieldset>
