...
<p>{gt text='A user changed his file "%s".' tag=$mailData.name}</p>
...
<p>{gt text='Edit the file:'} <a href="{$mailData.editUrl|safetext}" title="{gt text='Edit'}">{$mailData.editUrl|safetext}</a></p>
