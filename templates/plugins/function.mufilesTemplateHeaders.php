...
/**
 * The mufilesTemplateHeaders plugin performs header() operations
 ...
 */
function smarty_function_mufilesTemplateHeaders($params, $view)
{
    if (!isset($params['contentType'])) {
        $view->trigger_error($view->__f('%1$s: missing parameter \'%2$s\'', array('mufilesTemplateHeaders', 'contentType')));
    }
