...
<form action="{$modvars.ZConfig.entrypoint|default:'index.php'}" method="get" id="mUFilesCollectionQuickNavForm" class="mufiles-quicknav">
    <fieldset>
       ...
       {* {if !isset($inFrontendFilter) || $inFrontendFilter eq true}
                ...
                <select id="inFrontend" name="inFrontend">
                    <option value="">{$lblDefault}</option>
                {foreach item='option' from=$inFrontendItems}
...
/* <![CDATA[ */
    document.observe('dom:loaded', function() {
        mUMUFilesInitQuickNavigation('collection');
