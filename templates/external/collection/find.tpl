...
<body>
    ...
    <div>
        ...
        <fieldset>
            ...
            <div class="z-formrow">
                <label for="MUFiles_pasteas">{gt text='Paste as'}:</label>
                <select id="MUFiles_pasteas" name="pasteas">
            ...
            <div class="z-formrow">
                <label for="MUFiles_objectid">{gt text='Collection'}:</label>
                <div id="mufilesitemcontainer">
                    <ul>
                    {foreach item='collection' from=$items}
                        <li>
                            <a href="#" onclick="mufiles.finder.selectItem({$collection.id})" onkeypress="mufiles.finder.selectItem({$collection.id})">
                                {$collection.name}
                            </a>
                            ...
                            <input type="hidden" id="title{$collection.id}" value="{$collection.name|replace:"\"":""}" />
            ...
            <div class="z-formrow">
                <label for="MUFiles_sort">{gt text='Sort by'}:</label>
                <select id="MUFiles_sort" name="sort" style="width: 150px" class="z-floatleft" style="margin-right: 10px">
                ...
                <select id="MUFiles_sortdir" name="sortdir" style="width: 100px">
            ...
            <div class="z-formrow">
                <label for="MUFiles_pagesize">{gt text='Page size'}:</label>
                <select id="MUFiles_pagesize" name="num" style="width: 50px; text-align: right">
            ...
            <div class="z-formrow">
                <label for="MUFiles_searchterm">{gt text='Search for'}:</label>
                <input type="text" id="MUFiles_searchterm" name="searchterm" style="width: 150px" class="z-floatleft" style="margin-right: 10px" />
                <input type="button" id="MUFiles_gosearch" name="gosearch" value="{gt text='Filter'}" style="width: 80px" />
            </div>

            <div style="margin-left: 6em">
                {pager display='page' rowcount=$pager.numitems limit=$pager.itemsperpage posvar='pos' template='pagercss.tpl' maxpages='10'}
            </div>
            <input type="submit" id="MUFiles_submit" name="submitButton" value="{gt text='Change selection'}" />
            <input type="button" id="MUFiles_cancel" name="cancelButton" value="{gt text='Cancel'}" />
            <br />
        </fieldset>
    </div>
    </form>
