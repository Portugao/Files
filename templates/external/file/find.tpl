...
<body>
    ...
    <div>
        ...
        <fieldset>
            ...
            <div class="z-formrow">
                <label for="MUFiles_objectid">{gt text='File'}:</label>
                <div id="mufilesitemcontainer">
                    <ul>
                    {foreach item='file' from=$items}
                        <li>
                            <a href="#" onclick="mufiles.finder.selectItem({$file.id})" onkeypress="mufiles.finder.selectItem({$file.id})">
                                {$file.title}
                            </a>
                            <input type="hidden" id="url{$file.id}" value="{modurl modname='MUFiles' type='user' func='display' ot='file' id=$file.id fqurl=true}" />
                            <input type="hidden" id="title{$file.id}" value="{$file.title|replace:"\"":""}" />
