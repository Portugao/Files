...
{foreach item='collection' from=$items}
    <item>
        ...
        <link>{modurl modname='MUFiles' type='user' func='display' ot='collection' id=$collection.id fqurl='1'}</link>
        <guid>{modurl modname='MUFiles' type='user' func='display' ot='collection' id=$collection.id fqurl='1'}</guid>
