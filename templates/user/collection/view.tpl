...
<div class="mufiles-collection mufiles-view">
    ...
    {include file='user/collection/view_quickNav.tpl' all=$all own=$own}{* see template file for available options *}
    ...
    {if !isset($showAllEntries) || $showAllEntries ne 1}
        {pager rowcount=$pager.numitems limit=$pager.itemsperpage display='page' modname='MUFiles' type='user' func='view' ot='collection'}
    {/if}
