 ...
 */
class MUFiles_NewsletterPlugin_ItemList extends Newsletter_AbstractPlugin
{
    /**
    ...
    {
        return $this->__('Latest MUFiles items');
    }
    ...
    {
        return $this->__('List of collections and other MUFiles items');
    }
    ...
    {
        return $this->__('This plugin shows a list of collections and other items of the MUFiles module.');
    }
    ...
    public function getParameters()
    {
        ...
        if (ModUtil::available($this->modname) && ModUtil::loadApi($this->modname)) {
            ...
            $objectTypes['file'] = array('name' => $this->__('Files'));
        }
