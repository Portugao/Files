 ...
 */
class MUFiles_Form_Handler_Admin_File_Base_Edit extends MUFiles_Form_Handler_Admin_Edit
{
    /**
     * Pre-initialise hook.
     *
    ...
    public function preInitialize()
    {
        ...
        $this->uploadFields = array('uploadFile' => true);
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        $this->relationPresets['aliascollection'] = FormUtil::getPassedValue('aliascollection', '', 'GET');
        if (!empty($this->relationPresets['aliascollection'])) {
            $relObj = ModUtil::apiFunc($this->name, 'selection', 'getEntity', array('ot' => 'collection', 'id' => $this->relationPresets['aliascollection']));
            if ($relObj != null) {
    ...
    protected function getDefaultReturnUrl($args)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            ...
            $url = ModUtil::url($this->name, 'admin', 'display', array('ot' => 'file', 'id' => $this->idValues['id']));
        }
    ...
    protected function getRedirectUrl($args)
    {
        ...
        switch ($this->returnTo) {
            ...
            case 'adminDisplayCollection':
                if (!empty($this->aliascollection)) {
                    return ModUtil::url($this->name, 'admin', 'display', array('ot' => 'collection', 'id' => $this->aliascollection));
                }
                return $this->getDefaultReturnUrl($args);
            ...
            case 'userDisplayCollection':
                if (!empty($this->aliascollection)) {
                    return ModUtil::url($this->name, 'user', 'display', array('ot' => 'collection', 'id' => $this->aliascollection));
                }
                return $this->getDefaultReturnUrl($args);
                    default:
                        return $this->getDefaultReturnUrl($args);
