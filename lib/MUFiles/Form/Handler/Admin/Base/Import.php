 ...
 */
class MUFiles_Form_Handler_Admin_Base_Import extends Zikula_Form_AbstractHandler
{
    /**
    ...
    {
        if ($args['commandName'] == 'importCats') {
            
            $result = ModUtil::apiFunc($this->name, 'import', 'importCats');
        ...
        if ($args['commandName'] == 'importFiles') {
