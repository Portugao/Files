 ...
 */
class MUFiles_Form_Handler_User_File_Base_Edit extends MUFiles_Form_Handler_User_Edit
{
    /**
     * Pre-initialise hook.
     *
    ...
    protected function getDefaultReturnUrl($args)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            ...
            $url = ModUtil::url($this->name, 'user', 'display', array('ot' => 'file', 'id' => $this->idValues['id']));
        }
