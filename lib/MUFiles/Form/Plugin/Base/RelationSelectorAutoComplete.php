...
class MUFiles_Form_Plugin_Base_RelationSelectorAutoComplete extends MUFiles_Form_Plugin_AbstractObjectSelector
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        $createLink = '';
        if ($this->createLink != '') {
            $createLink = '<a id="' . 'SelectorDoNew" href="' . DataUtil::formatForDisplay($this->createLink) . '" title="' . __f('Create new %s', array($entityNameTranslated), $dom) . '" class="z-button mufiles-inline-button">' . __('Create', $dom) . '</a>';
        }
