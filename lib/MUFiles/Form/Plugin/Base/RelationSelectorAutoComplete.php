...
class MUFiles_Form_Plugin_Base_RelationSelectorAutoComplete extends MUFiles_Form_Plugin_AbstractObjectSelector
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        $createLink = '';
        if ($this->createLink != '') {
            $createLink = '<a id="' . 'SelectorDoNew" href="' . DataUtil::formatForDisplay($this->createLink) . '" title="' . __f('Create new %s', array($entityName), $dom) . '" class="z-button mufilesInlineButton">' . __('Create', $dom) . '</a>';
        }

        $alias = $this->id;

        $result = '
            <div class="mufilesRelationRightSide">'
                . $addLink . '
                <div id="' . $idPrefix . 'AddFields">
                    ...
                    <div id="' . $idPrefix . 'SelectorChoices" class="mufilesAutoComplete' . (($this->withImage) ? 'WithImage' : '') . '"></div>
                    <input type="button" id="' . $idPrefix . 'SelectorDoCancel" name="' . $idPrefix . 'SelectorDoCancel" value="' . __('Cancel', $dom) . '" class="z-button mufilesInlineButton" />'
                    . $createLink . '
