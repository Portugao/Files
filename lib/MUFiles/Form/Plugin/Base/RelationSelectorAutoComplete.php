 ...
 */
     ...
     */
    class MUFiles_Form_Plugin_Base_RelationSelectorAutoComplete extends MUFiles_Form_Plugin_AbstractObjectSelector
    {
        /**
        ...
        public function render(Zikula_Form_View $view)
        {
            ...
            $createLink = '';
            if ($this->createLink != '') {
                $createLink = '<a id="' . $idPrefix . 'SelectorDoNew" href="' . DataUtil::formatForDisplay($this->createLink) . '" title="' . __f('Create new %s', array($entityNameTranslated), $dom) . '" class="z-button mufiles-inline-button">' . __('Create', $dom) . '</a>';
            }

            $alias = $this->id;

            $result = '
                <div class="mufiles-relation-rightside">'
                    . $addLink . '
                    <div id="' . $idPrefix . 'AddFields">
                        ...
                        <div id="' . $idPrefix . 'SelectorChoices" class="mufiles-autocomplete' . (($this->withImage) ? '-with-image' : '') . '"></div>
                        <input type="button" id="' . $idPrefix . 'SelectorDoCancel" name="' . $idPrefix . 'SelectorDoCancel" value="' . __('Cancel', $dom) . '" class="z-button mufiles-inline-button" />'
                        . $createLink . '
