 ...
 */
class MUFiles_ContentType_Base_Item extends Content_AbstractContentType
{
    ...
    public function getTitle()
    {
        ...
        return __('MUFiles detail view', $dom);
    }
    ...
    public function getDescription()
    {
        ...
        return __('Display or link a single MUFiles object.', $dom);
    }
    ...
    public function display()
    {
        if ($this->id != null && !empty($this->displayMode)) {
            return ModUtil::func('MUFiles', 'external', 'display', $this->getDisplayArguments());
        }
