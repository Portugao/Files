 ...
 */
class MUFiles_ContentType_Base_ItemList extends Content_AbstractContentType
{
    /**
    ...
    public function getTitle()
    {
        ...
        return __('MUFiles list view', $dom);
    }
    ...
    public function getDescription()
    {
        ...
        return __('Display list of MUFiles objects.', $dom);
    }
    ...
    public function loadData(&$data)
    {
        ...
        if (in_array($this->objectType, $this->categorisableObjectTypes)) {
            $idFields = ModUtil::apiFunc('MUFiles', 'selection', 'getIdFields', array('ot' => $this->objectType));
            $this->catRegistries = ModUtil::apiFunc('MUFiles', 'category', 'getAllPropertiesWithMainCat', array('ot' => $this->objectType, 'arraykey' => $idFields[0]));
            $this->catProperties = ModUtil::apiFunc('MUFiles', 'category', 'getAllProperties', array('ot' => $this->objectType));
        }
    
        if (!isset($data['catIds'])) {
            $primaryRegistry = ModUtil::apiFunc('MUFiles', 'category', 'getPrimaryProperty', array('ot' => $this->objectType));
    ...
    public function display()
    {
        ...
        if (in_array($this->objectType, $this->categorisableObjectTypes)) {
            if (is_array($this->catIds) && count($this->catIds) > 0) {
                $categoryFiltersPerRegistry = ModUtil::apiFunc('MUFiles', 'category', 'buildFilterClauses', array('ot' => $this->objectType, 'catids' => $this->catIds));
        ...
        $this->view->toplevelmodule = 'MUFiles';
        ...
        list($entities, $objectCount) = ModUtil::apiFunc('MUFiles', 'selection', 'getEntitiesPaginated', $selectionArgs);
    ...
    public function startEditing()
    {
        ...
        array_push($this->view->plugins_dir, 'modules/MUFiles/templates/plugins');
