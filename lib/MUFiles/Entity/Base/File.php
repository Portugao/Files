...
abstract class MUFiles_Entity_Base_File extends Zikula_EntityAccess
{
    ...
    {
        if ($uploadFileFullPath != $this->uploadFileFullPath) {
    ...
    {
        if ($uploadFileFullPathUrl != $this->uploadFileFullPathUrl) {
    ...
    {
        if ($uploadFileMeta != $this->uploadFileMeta) {
     ...
     * Set aliascollection.
     *
     * @param nullMUFiles_Entity_Collection $aliascollection.
     *
     * @return void
     */
    public function setAliascollection(nullMUFiles_Entity_Collection $aliascollection = null)
    {
