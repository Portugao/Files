 ...
 *
 * This is the base repository class for file entities.
 */
class MUFiles_Entity_Repository_Base_File extends EntityRepository
{
    /**
    ...
    public function getDescriptionFieldName()
   {
    ...
    public function getAdditionalTemplateParameters($context = '', $args = array())
    {
        ...
        if ($context == 'controllerAction') {
            ...
            if (in_array($args['action'], array('main', 'view'))) {
                ...
                $templateParameters['workflowStateItems'] = $listHelper->getEntries('file', 'workflowState');
            }
    
            // initialise Imagine preset instances
            $imageHelper = new MUFiles_Util_Image(ServiceUtil::getManager());
    
            $objectType = 'file';
            $templateParameters[$objectType . 'ThumbPresetUploadFile'] = $imageHelper->getPreset($objectType, 'uploadFile', $context, $args);
    ...
    protected function getViewQuickNavParameters($context = '', $args = array())
    {
        ...
        $parameters = array();
        $parameters['aliascollection'] = isset($this->controllerArguments['aliascollection']) ? $this->controllerArguments['aliascollection'] : FormUtil::getPassedValue('aliascollection', 0, 'GET');
    ...
    public function truncateTable()
    {
        ...
        $qb->delete('MUFiles_Entity_File', 'tbl');
        $query = $qb->getQuery();
    ...
    public function updateCreator($userId, $newUserId)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->update('MUFiles_Entity_File', 'tbl')
     ...
     *
     * @return array|MUFiles_Entity_File retrieved data array or MUFiles_Entity_File instance
     *
     * @throws InvalidArgumentException Thrown if invalid parameters are received
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false).
     *
     * @return ArrayCollection collection containing retrieved MUFiles_Entity_File instances
     */
    ...
    public function addCommonViewFilters(QueryBuilder $qb)
    {
        ...
        foreach ($parameters as $k => $v) {
            if ($k == 'catId') {
                 ...
                 */
                $qb = ModUtil::apiFunc('MUFiles', 'category', 'buildFilterClauses', array('qb' => $qb, 'ot' => 'file', 'catids' => $v));
            } elseif ($k == 'searchterm') {
                // quick search
                if (!empty($v)) {
    ...
    protected function applyDefaultFilters(QueryBuilder $qb, $parameters = array())
    {
        ...
        if ($currentType == 'admin' && $currentModule == 'MUFiles') {
            return $qb;
        }
