...
class MUFiles_Entity_Repository_Base_File extends EntityRepository
{
    ...
    public function getDescriptionFieldName()
   {
    ...
    public function getAdditionalTemplateParameters($context = '', $args = array())
    {
        ...
        if ($context == 'controllerAction') {
            ...
            if (in_array($args['action'], array('main', 'view'))) {
                ...
                $listHelper = new MUFiles_Util_ListEntries($serviceManager);
            ...
            $objectType = 'file';
            $parameters[$objectType . 'ThumbManagerUploadFile'] = $imageHelper->getManager($objectType, 'uploadFile', $context, $args);
            if (in_array($args['action'], array('display', 'view'))) {
                // use seperate preset for images in related items
                $parameters['relationThumbPreset'] = $imageHelper->getPreset('', '', 'MUFiles_relateditem', $context, $args);
            }
        }
    ...
    protected function getViewQuickNavParameters($context = '', $args = array())
    {
        ...
        $parameters = array();
        $parameters['aliascollection'] = FormUtil::getPassedValue('aliascollection', 0, 'GET');
    ...
    protected function addCommonViewFilters(QueryBuilder $qb)
    {
        ...
        foreach ($parameters as $k => $v) {
            if ($k == 'catId') {
                 ...
                 */
                $categoryFiltersPerRegistry = ModUtil::apiFunc('MUFiles', 'category', 'buildFilterClauses', array('ot' => 'file', 'catids' => $v));
    ...
    protected function getQueryFromBuilder(QueryBuilder $qb)
    {
        ...
        //$fu = new FilterUtil('MUFiles', $this);
