...
class MUFiles_Entity_Repository_Base_Collection extends EntityRepository
{
    ...
    public function getDescriptionFieldName()
   {
    ...
    protected function getViewQuickNavParameters($context = '', $args = array())
    {
        ...
        $parameters['parent'] = FormUtil::getPassedValue('parent', 0, 'GET');
    ...
    protected function addCommonViewFilters(QueryBuilder $qb)
    {
        ...
        foreach ($parameters as $k => $v) {
            if ($k == 'catId') {
                 ...
                 */
                $categoryFiltersPerRegistry = ModUtil::apiFunc('MUFiles', 'category', 'buildFilterClauses', array('ot' => 'collection', 'catids' => $v));
