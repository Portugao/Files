...
class MUFiles_Entity_Hookobject extends MUFiles_Entity_Base_Hookobject
{
     ...
     *
     * @ORM\PostLoad
     * @see MUFiles_Entity_Hookobject::performPostLoadCallback()
     * @return void.
     */
     ...
     *
     * @ORM\PrePersist
     * @see MUFiles_Entity_Hookobject::performPrePersistCallback()
     * @return void.
     */
     ...
     *
     * @ORM\PostPersist
     * @see MUFiles_Entity_Hookobject::performPostPersistCallback()
     * @return void.
     */
     ...
     *
     * @ORM\PreRemove
     * @see MUFiles_Entity_Hookobject::performPreRemoveCallback()
     * @return void.
     */
     ...
     *
     * @ORM\PostRemove
     * @see MUFiles_Entity_Hookobject::performPostRemoveCallback()
     * @return void
     */
     ...
     *
     * @ORM\PreUpdate
     * @see MUFiles_Entity_Hookobject::performPreUpdateCallback()
     * @return void.
     */
     ...
     *
     * @ORM\PostUpdate
     * @see MUFiles_Entity_Hookobject::performPostUpdateCallback()
     * @return void.
     */
     ...
     * @ORM\PrePersist
     * @ORM\PreUpdate
     * @see MUFiles_Entity_Hookobject::performPreSaveCallback()
     * @return void.
     */
     ...
     * @ORM\PostPersist
     * @ORM\PostUpdate
     * @see MUFiles_Entity_Hookobject::performPostSaveCallback()
     * @return void.
     */
