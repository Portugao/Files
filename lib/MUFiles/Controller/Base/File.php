 ...
 */
class MUFiles_Controller_Base_File extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
    ...
    public function main()
    {
        ...
        $objectType = 'file';
        $utilArgs = array('controller' => 'file', 'action' => 'main');
        ...
        if ($legacyControllerType == 'admin') {
            ...
            $redirectUrl = ModUtil::url($this->name, 'file', 'view', array('lct' => $legacyControllerType));
        ...
        // set caching id
        $this->view->setCacheId('file_main');
        
        // return main template
        return $this->view->fetch('file/main.tpl');
    }
    ...
    public function view()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'file';
        $utilArgs = array('controller' => 'file', 'action' => 'view');
        ...
        $currentUrlObject = new Zikula_ModUrl($this->name, 'file', 'view', ZLanguage::getLanguageCode(), $currentUrlArgs);
    ...
    public function delete()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'file';
        $utilArgs = array('controller' => 'file', 'action' => 'delete');
        ...
        if (!$deleteAllowed) {
            return LogUtil::registerError($this->__('Error! It is not allowed to delete this file.'));
        }
        ...
        if ($confirmation && $deleteAllowed) {
            ...
            if (!$validators->hasErrors()) {
                ...
                // Let any hooks know that we have created, updated or deleted the file
                $hookType = 'process_delete';
                $hook = new Zikula_ProcessHook($hookAreaPrefix . '.' . $hookType, $entity->createCompositeIdentifier());
                $this->notifyHooks($hook);
        
                // The file was deleted, so we clear all cached pages this item.
    ...
    public function handleSelectedEntries()
    {
        ...
        $redirectUrl = ModUtil::url($this->name, 'admin', 'main', array('ot' => 'file'));
        ...
        foreach ($items as $itemid) {
            ...
            if ($action != 'delete') {
                ...
                $url = new Zikula_ModUrl($this->name, 'file', 'display', ZLanguage::getLanguageCode(), $urlArgs);
            }
    ...
    public function handleInlineRedirect()
    {
        ...
        $this->view->display('file/inlineRedirectHandler.tpl');
