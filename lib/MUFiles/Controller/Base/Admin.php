 ...
 */
class MUFiles_Controller_Base_Admin extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
    ...
    public function view(array $args = array())
    {
        ...
        $objectType = (isset($args['ot']) && !empty($args['ot'])) ? $args['ot'] : $this->request->query->filter('ot', 'collection', FILTER_SANITIZE_STRING);
