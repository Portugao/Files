...
/**
 * Hookobject controller base class.
 */
class MUFiles_Controller_Base_Hookobject extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
    ...
    public function main()
    {
        ...
        if ($legacyControllerType == 'admin') {
            ...
            $redirectUrl = ModUtil::url($this->name, 'hookobject', 'view', array('lct' => $legacyControllerType));
        ...
        // set caching id
        $this->view->setCacheId('hookobject_main');
        
        // return main template
        return $this->view->fetch('hookobject/main.tpl');
    }
    ...
    public function view()
    {
        ...
        $currentUrlObject = new Zikula_ModUrl($this->name, 'hookobject', 'view', ZLanguage::getLanguageCode(), $currentUrlArgs);
    ...
    public function edit()
    {
        ...
        $handlerClass = $this->name . '_Form_Handler_Hookobject_Edit';
    ...
    public function delete()
    {
        ...
        if (!$deleteAllowed) {
            return LogUtil::registerError($this->__('Error! It is not allowed to delete this hookobject.'));
        }
        ...
        if ($confirmation && $deleteAllowed) {
            ...
            if (!$validators->hasErrors()) {
                ...
                // Let any hooks know that we have created, updated or deleted the hookobject
                $hookType = 'process_delete';
                $hook = new Zikula_ProcessHook($hookAreaPrefix . '.' . $hookType, $entity->createCompositeIdentifier());
                $this->notifyHooks($hook);
        
                // The hookobject was deleted, so we clear all cached pages this item.
    ...
    public function handleSelectedEntries()
    {
        ...
        $redirectUrl = ModUtil::url($this->name, 'admin', 'main', array('ot' => 'hookobject'));
        ...
        foreach ($items as $itemid) {
            ...
            if ($action != 'delete') {
                ...
                $url = new Zikula_ModUrl($this->name, 'hookobject', 'display', ZLanguage::getLanguageCode(), $urlArgs);
            }
    ...
    public function handleInlineRedirect()
    {
        ...
        $this->view->display('hookobject/inlineRedirectHandler.tpl');
