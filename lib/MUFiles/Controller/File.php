        ...
        if ($showAllEntries == 1) {
            ...
            if ($resultsPerPage == 0) {
                if ($legacyControllerType == 'user') {
                    $resultsPerPage = $this->getVar('itemsPerPage', 10);
                } else {
                    $resultsPerPage = $this->getVar('itemsPerPageBackend', 10);
                }
            }
        ...
        if ($confirmation && $deleteAllowed) {
            ...
            if (!$validators->hasErrors()) {
                ...
                if ($legacyControllerType == 'admin') {
                    ...
                    $redirectUrl = ModUtil::url($this->name, 'admin', 'view', array('ot' => 'File', 'lct' => $legacyControllerType));
                } else {
                    // redirect to the list of files
